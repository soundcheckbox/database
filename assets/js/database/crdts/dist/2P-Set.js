...
class OperationTuple3$1 {
  ...
  static create (value, added, removed) {
    return new OperationTuple3$1(value, added, removed)
  }

  static from (json) {
    return OperationTuple3$1.create(json.value, json.added, json.removed)
  }
}

utils.OperationTuple3 = OperationTuple3$1;

const { OperationTuple3 } = utils;
...
var CmRDTSet_1 = CmRDTSet;

const CRDTSet$1 = CmRDTSet_1;
 ...
 */
class GSet$1 extends CRDTSet$1 {
  /**
   ...
   */
  static from (json) {
    return new GSet$1(json.values)
  }
}

var GSet_1 = GSet$1;

const CRDTSet = CmRDTSet_1;
const GSet = GSet_1;

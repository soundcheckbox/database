...
import require$$2 from '../../level-codec/dist/index.js';
import require$$3 from '../../level-errors/dist/index.js';

const AbstractLevelDOWN = require$$0.AbstractLevelDOWN;
const AbstractChainedBatch = require$$0.AbstractChainedBatch;
const AbstractIterator = require$$0.AbstractIterator;
const inherits = require$$1;
const Codec = require$$2;
const EncodingError = require$$3.EncodingError;
...
DB.prototype._put = function (key, value, opts, cb) {
  ...
  console.log('ZBCOMMENT encoding down', {
    key: key,
    value: value,
    opts: opts,
  })
...
export { encodingDown as default };
